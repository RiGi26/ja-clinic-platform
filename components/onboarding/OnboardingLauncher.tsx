...
// ============================================================
// OnboardingLauncher — mounted once in the admin layout. Owns the first-run
// flow: welcome modal → tour. Listens for a window event so the checklist and
// the "?" help button can replay the tour on demand. Persistence is
// fire-and-forget (server actions revalidate).
// ============================================================
