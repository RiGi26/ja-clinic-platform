...
//
// Clinic tenants live in this portal's own Supabase, but subscriptions + payment
...
export function appOrigin(): string {
  return (process.env.NEXT_PUBLIC_APP_URL?.trim().replace(/\/+$/, '')) || 'https://clinic.webzoka.com'
}
